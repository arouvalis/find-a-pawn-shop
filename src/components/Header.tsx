    ...
    <header style={{ backgroundColor: "#1a2744" }} className="text-white">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6 text-sm">
          ...
          <Link href="/ohio" className="hover:text-amber-400 transition-colors">
            Ohio
          </Link>
          <Link href="/michigan" className="hover:text-amber-400 transition-colors">
            Michigan
          </Link>
          <Link href="/pennsylvania" className="hover:text-amber-400 transition-colors">
            Pennsylvania
          </Link>
