...
export async function generateMetadata(): Promise<Metadata> {
  const total =
    ...
    getAllMontanaShops().length +
    getAllVermontShops().length;
  return {
...
export default function HomePage() {
  ...
  const topCities = [
    ...
    ...montanaCities.map((c) => ({ ...c, stateSlug: "montana", stateLabel: "Montana" })),
    ...vermontCities.map((c) => ({ ...c, stateSlug: "vermont", stateLabel: "Vermont" })),
  ]
